...
//          cadena += `
//          <option value="${medico.id}">${medico.nombrem}</option>
//          `;
//      });
//           $('#smedico').html(cadena);
//    });
...
//});
 $('#add').click(function (e){
    ...
    $.post('idp.php',{cel:$('#celular').val()}, function (response){
        console.log(response);
    });
    
    //window.location = "/agecit/registro/empresa/" ;
...
//          if(medico.id===me)
//          cadena += `
//          <option selected value="${medico.id}">${medico.nombrem}</option>
//          `;
//                else
//                cadena += `
//          <option value="${medico.id}">${medico.nombrem}</option>
...
//   e.preventDefault(); 
//   console.log("clic en #mod es "+ $('#id').val());
//   let id = $('#id').val();
//   const postDataJS = {
//      id : id,
//      nom : $('#nombre').val(),
